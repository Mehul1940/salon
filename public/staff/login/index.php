...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($email) || empty($password)) {
        ...
        $staff = $connection->findOne("users", ["email" => $email, "role" => "staff"]);
...
<div class="d-flex vh-100">
    <div class="col-md-6 d-none d-md-flex align-items-center justify-content-center p-5 auth-image"
        ...
        <div class="text-white text-center">
            <h1 class="display-5 fw-bold mb-3 text-uppercase text-white">Staff Panel</h1>
            <p class="lead">Manage your assigned services and appointments efficiently.</p>
        </div>
    </div>
    ...
    <div class="col-md-6 auth-form-container d-flex align-items-center justify-content-center p-5"
        ...
        <div class="p-4 rounded bg-white w-100" style="max-width: 450px;">
            <div class="text-center mb-4">
                <img src="<?= ASSETS_PATH . 'images/logo.svg' ?>" alt="Dhwani's Salon Staff" height="80" />
            </div>
            ...
            <form method="POST">
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" name="email" class="form-control" id="email" placeholder="staff@example.com" required>
                    </div>
                </div>
